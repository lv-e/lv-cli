...
function encode(input, output, mode) {
    return __awaiter(this, void 0, void 0, function* () {
        if (mode == "help")
            ...
            // load project file
            index_1.syslog("planning build");
            const projectJson = fs_1.readFileSync(input, "utf8");
            const projectData = JSON.parse(projectJson);
            // encode project
            index_1.syslog("building project's lvk.h");
            exports.project = encode_project_1.encodeProject(projectData);
            ...
            index_1.syslog("encoding shared content");
